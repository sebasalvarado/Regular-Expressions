...
public class Driver {
  ...
  public static Database currDatabase = new Database();
  ...
  public static void uploadClientInfo(String path) throws IOException {
    currDatabase.uploadClientInfo(path);
  }
  ...
  public static void uploadFlightInfo(String path) throws IOException {
    currDatabase.uploadFlightInfo(path);
  }
  ...
  public static String getClient(String email) {
    return currDatabase.getClient(email).toString();
  }
  ...
  public static String getFlights(String date, String origin, String destination) {
    return currDatabase.searchFlights(date, origin, destination);
  }
  ...
  public static String getItineraries(String date, String origin, String destination) {
    ArrayList<Itinerary> itineraries = currDatabase.getItineraries(date, origin, destination);
    String stringItineraries =  currDatabase.printItineraries(itineraries);
    return stringItineraries;
  }
  ...
  public static String getItinerariesSortedByCost(String date, String origin, String destination) {
    ArrayList<Itinerary> itineraries =  currDatabase.getItineraries(date, origin, destination);
    ArrayList<Itinerary> itinerariesCost =  currDatabase.totalCostSort(itineraries);
    String stringItineraries =  currDatabase.printItineraries(itinerariesCost);
    return stringItineraries;
  }
  ...
  public static String getItinerariesSortedByTime(String date, String origin, String destination) {
    ArrayList<Itinerary> itineraries = currDatabase.getItineraries(date, origin, destination);
    ArrayList<Itinerary> itinerariesTravelTime =  Database.totalTravelTimeSort(itineraries);
    String stringItineraries =  currDatabase.printItineraries(itinerariesTravelTime);
    return stringItineraries;
  }
